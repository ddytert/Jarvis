...
class LastFMService {
    ...
    public func searchForArtist(_ artistName: String, completion: @escaping ([Artist]?, String) -> Void) {
    ...
    public func fetchTopAlbumsOfArtist(_ artistName: String, completion: @escaping ([JarvisAlbum]?, String) -> Void) {
    ...
    public func imageForURL(_ urlString: String, completion: @escaping (UIImage?) -> Void) {
